    ...
    render() {
        return(
            <div id="about">
                ...
                <p>Post your lost items per state with detailed location and date found for other users to surf and hopfully find there lost items. Leave your contact info for other users to reach you at.</p>
            </div>
        );
    }
}
